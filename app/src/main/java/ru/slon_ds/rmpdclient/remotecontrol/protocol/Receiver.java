...
public class Receiver {
    ...
    public Receiver(ControlWrapper control_wrapper, IncomingMessage data, Integer sequence_number) throws JSONException, ClassNotFoundException,
        ...
        command_object = (BaseCommand)
                Class.forName(command_class_name).getConstructor(ControlWrapper.class, IncomingMessage.class, Integer.class)
