...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends BasePreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
            if (getResources().getString(R.string.pref_key_disable_sustemui).equals(s)) {
                SwitchPreference sp = (SwitchPreference) findPreference(s);
                boolean current_value = sharedPreferences.getBoolean(s, false);

                String toast_text;
                boolean res = Control.set_systemui_disabled(current_value);
                if (!res) {
                    sp.setChecked(current_value);
                    SharedPreferences.Editor e = sharedPreferences.edit();
                    e.putBoolean(s, !current_value);
                    e.apply();
                    toast_text = "Error " + (current_value ? "enabling" : "disabling") + " system UI";
                } else {
                    toast_text = "System UI successfully " + (current_value ? "enabled" : "disabled") + ". Reboot to apply now";
                }
                Toast toast = Toast.makeText(AndroidApplication.context(), toast_text, Toast.LENGTH_LONG);
                toast.show();
            }
        }
    }
    ...
    public static class NetworkPreferenceFragment extends BasePreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            final Resources res = getResources();
            bindPreferenceSummaryToValue(findPreference(res.getString(R.string.pref_key_server_uri)));
